<?php
        ...
        $mcFileManagerConfig['general.tools'] = "imagemanager,createdir,refresh,zip,upload,edit,rename,cut,copy,paste,delete,selectall,unselectall,view,download,insert,addfavorite,removefavorite";
		...
		$p = preg_replace('/\/kernel\/src\/ctrl\/mce\/plugins\/filemanager\/.*index\.php/i', '', $_SERVER['SCRIPT_FILENAME']).'/var/mce';
        // General file system options
        $mcFileManagerConfig['filesystem'] = "Moxiecode_LocalFileImpl";
       	$mcFileManagerConfig['filesystem.path'] = $p.'/file'; // absolute or relative from this script path, optional.
		$mcFileManagerConfig['filesystem.rootpath'] = $p; // absolute or relative from this script path, required.
        ...
        $mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,xml,doc,docx,rtf,rar,xls";
        ...
        // Upload options
        $mcFileManagerConfig['upload.maxsize'] = "1024MB";
        ...
        $mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,swf,flv,xml,doc,docx,rtf,rar,xls";
        ...
        $mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,pdf,txt,zip,swf,flv";
        ...
        $mcFileManagerConfig['edit.extensions'] = "html,htm,txt,css";
		...
		$mcImageManagerConfig['SessionAuthenticator.config_prefix'] = "filemanager";
