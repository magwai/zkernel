<?php
	...
	$mcImageManagerConfig['general.tools'] = "filemanager,createdir,upload,refresh,insert,delete,edit,preview,addfavorite,removefavorite"; // "filemanager" button if you have "filemanager.urlprefix" configured.
	...
	$p = preg_replace('/\/kernel\/src\/ctrl\/mce\/plugins\/imagemanager\/.*index\.php/i', '', $_SERVER['SCRIPT_FILENAME']).'/var/mce';
	// General filesystem options
	$mcImageManagerConfig['filesystem'] = "Moxiecode_LocalFileImpl";
	$mcImageManagerConfig['filesystem.path'] = $p.'/image'; // absolute or relative from this script path, optional.
	$mcImageManagerConfig['filesystem.rootpath'] = $p; // absolute or relative from this script path, required.
