...
jQuery.fn.daterangepicker = function(settings){
	...
	if(rangeInput.size() == 2){
		...
		var val1 = rangeInput.val();
		inputDateAtemp = Date.parse( val1 ? val1.split(options.rangeSplitter)[0] : '' );
		inputDateBtemp = Date.parse( val1 ? val1.split(options.rangeSplitter)[1] : '' );
