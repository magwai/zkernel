...
class Zkernel_Form_Element_Uploadify3 extends Zend_Form_Element_Hidden {
	public $helper = 'formUploadify3';

	public function render(Zend_View_Interface $view = null) {
    	$o = array(
            'buttonText' => /*$this->button ? $this->button : */'Browse...',
    		'fileObjName' => $this->getName(),
	    	'postData' => array(
    	...
    	$js =
'$.include("/zkernel/ctl/uploadify3/uploadify.css|link");
