 ...
 * @license    http://code.google.com/p/Zkernel/wiki/License     New BSD License
 */
class Zkernel_Controller_Plugin_Debug_Plugin_Auth implements Zkernel_Controller_Plugin_Debug_Plugin_Interface
{
    /**
    ...
    /**
     * Create Zkernel_Controller_Plugin_Debug_Plugin_Auth
     *
     * @var string $user
     * @var string $role
     * @return void
