 ...
 * @license    http://code.google.com/p/Zkernel/wiki/License     New BSD License
 */
class Zkernel_Controller_Plugin_Debug_Plugin_File implements Zkernel_Controller_Plugin_Debug_Plugin_Interface
{
    /**
    ...
    public function __construct(array $options = array())
    {
        ...
        $this->_library = array_merge($options['library'], array('Zend', 'Zkernel'));
    }
