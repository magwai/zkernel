 ...
 * @license    http://code.google.com/p/Zkernel/wiki/License     New BSD License
 */
class Zkernel_Controller_Plugin_Debug_Plugin_Time extends Zend_Controller_Plugin_Abstract implements Zkernel_Controller_Plugin_Debug_Plugin_Interface
{
    /**
    ...
    public function getPanel()
    {
        ...
        $timerNamespace = new Zend_Session_Namespace('Zkernel_Time',false);
        ...
        $html .= '<br />Reset timers by sending Zkernel_RESET as a GET/POST parameter';
    ...
    {
        $reset = Zend_Controller_Front::getInstance()->getRequest()->getParam('Zkernel_RESET');
        if (isset($reset)) {
            $timerNamespace = new Zend_Session_Namespace('Zkernel_Time',false);
