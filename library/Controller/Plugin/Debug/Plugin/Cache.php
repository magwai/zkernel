 ...
 * @license    http://code.google.com/p/Zkernel/wiki/License     New BSD License
 */
class Zkernel_Controller_Plugin_Debug_Plugin_Cache implements Zkernel_Controller_Plugin_Debug_Plugin_Interface
{
    /**
    ...
    /**
     * Create Zkernel_Controller_Plugin_Debug_Plugin_Cache
     *
     * @param array $options
     * @return void
     */
    public function __construct(array $options = array())
    {
        if (!isset($options['backend'])) {
            throw new Zend_Exception("Zkernel: Cache plugin needs 'backend' parameter");
        }
