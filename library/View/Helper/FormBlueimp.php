...
class Zkernel_View_Helper_FormBlueimp extends Zend_View_Helper_FormFile {
    public function formBlueimp($name, $value = null, $attribs = null) {
    	$url = @$attribs['url'];
