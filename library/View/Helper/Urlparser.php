<?php
    ...
    class Zkernel_View_Helper_Urlparser extends Zend_View_Helper_Abstract {
         ...
         * @return Array
         */
        public function getParams($sUrl) {
         ...
         */
        public function setParams($sUrl, $aParams) {
            $aUrl = self::explode($sUrl);
            $aUrl['query'] = '';
         ...
         * @return  String Newly compiled url
         */
        public function updateParams($sUrl, $aParams) {
            $aUrl = self::explode($sUrl);
            $aUrl['query'] = '';
